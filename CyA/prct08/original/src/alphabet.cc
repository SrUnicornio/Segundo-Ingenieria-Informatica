 ...
 */
Alphabet::Alphabet(const std::string& alphabet_symbols) {
...
/**
 * @brief Constructor de la clase Alphabet.
 * @param symbol - El símbolo que forma parte del alfabeto.
 */
Alphabet::Alphabet(const Symbol& symbol) {
  ValidateAlphabetSymbols(std::string(1, symbol.GetSymbol()));
  InsertSymbol(symbol);
}
 ...
 * @param symbol - El símbolo a eliminar.
 */
