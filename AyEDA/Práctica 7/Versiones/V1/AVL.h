...
private:
  ...
  void rotationLL(NodoAVL<Key> *&node)
  {
    ...
    {
      levels(raiz);
      std::cout << "Rotation LL in [" << node->getData() << "](" << node->getBal() << ")\n";
    }
  ...
  void rotationRR(NodoAVL<Key> *&node)
  {
    ...
    {
      levels(raiz);
      std::cout << "Rotation RR in [" << node->getData() << "](" << node->getBal() << ")\n";
    }
  ...
  void rotationLR(NodoAVL<Key> *&node)
  {
    ...
    {
      levels(raiz);
      std::cout << "Rotation LR in [" << node->getData() << "](" << node->getBal() << ")\n";
    }
    NodoAVL<Key> *node1 = node->izquierdo;
  ...
  void rotationRL(NodoAVL<Key> *&node)
  {
    ...
    {
      levels(raiz);
      std::cout << "Rotation RL in [" << node->getData() << "](" << node->getBal() << ")\n";
    }
    NodoAVL<Key> *node1 = node->derecho;
  ...
  void levels(const NodoAVL<Key> *node) const
  {
    ...
    while (!Q.empty())
    {
      ...
      if (aux != nullptr)
      {
        if (showTrace == true)
        {
          std::cout << "[" << aux->getData() << "(" << aux->getBal() << ")] ";
        }
        else
