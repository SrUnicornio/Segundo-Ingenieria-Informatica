...
AB<NIF> *CreateTree(program_options::tree_tipe tipe, bool showTrace = false)
{
  switch (tipe)
  {
...
void arbolTipe(AB<NIF> **ab, program_options options)
{
  ...
  AB<NIF> *newTree = CreateTree(tipe, options.showTrace);
