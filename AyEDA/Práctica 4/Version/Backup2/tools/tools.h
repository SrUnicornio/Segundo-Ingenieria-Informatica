...
void Menu(HashTable<Key, Container> *table)
{
  ...
  while (std::cin >> option)
  {
    ...
    case 2:
    {
      ...
      std::cout << "Value of NIF: " << value << " in position: " << table->GetIndex(value) << std::endl;
      break;
    }
    case 3:
      std::cout << "Saliendo...\n";
...
void initializeFunctions(const program_options &options, DispersionFunction<NIF> *&dispersion, ExplorationFunction<NIF> *&exploration)
{
